...
public class Part1 {
    ...
    public void testFindGene() {
        ...
        System.out.println("Gene: " + findGene(dna1, 0)); // Should return "ATGCTAA"

        String dna2 = "ATGCCCTAG";
        System.out.println("DNA sequence: " + dna2);
        System.out.println("Gene: " + findGene(dna2, 0)); // Should return "ATGCCCTAG"

        String dna3 = "ATGCCCATAAGTAG";
        System.out.println("DNA sequence: " + dna3);
        System.out.println("Gene: " + findGene(dna3, 0)); // Should return "ATGCCCATAAG"

        String dna4 = "ATGCCCCCCCC";
        System.out.println("DNA sequence: " + dna4);
        System.out.println("Gene: " + findGene(dna4, 0)); // Should return ""

        String dna5 = "CCCCCCCCCCCC";
        System.out.println("DNA sequence: " + dna5);
        System.out.println("Gene: " + findGene(dna5, 0)); // Should return ""
    }
    ...
    public static void main(String[] args) {
        ...
        part1.testFindGene();
        part1.testGetAllGenes(); // Should print all genes found in the DNA string
    }
}
